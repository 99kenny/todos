...
<body>
	<form action="/todosapp/from" accept-charset="utf-8" name="newTodo" method="post">
		...
		<main>
			...
			<div id="sequence">
				<h3>우선순위를 선택하세요</h3>
				<input class="radiobox" type="radio" name="type" value="1순위">1순위</input>
				<input class="radiobox" type="radio" name="type" value="2순위">2순위</input>
				<input class="radiobox" type="radio" name="type" value="3순위">3순위</input>
			</div>
		</main>
		<footer>
